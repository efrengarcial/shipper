...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9798df3feff9936a, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9798df3feff9936a, []int{1}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9798df3feff9936a, []int{2}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_9798df3feff9936a, []int{3}
}
...
func init() {
	proto.RegisterFile("proto/consignment/consignment.proto", fileDescriptor_consignment_9798df3feff9936a)
}

var fileDescriptor_consignment_9798df3feff9936a = []byte{
